...
export default function SignupForm({ googleEnabled }: { googleEnabled: boolean }) {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-ink-soft">Start tracking your money in minutes.</p>
      ...
      <form action={action} className="mt-5 space-y-4">
        <div>
          ...
          <input id="name" name="name" type="text" autoComplete="name" className="input" placeholder="Alex Rivera" />
        </div>
        <div>
