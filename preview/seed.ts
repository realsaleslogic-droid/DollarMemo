// Browser seed generator for the preview — mirrors prisma/seed.ts but returns
// client Transaction objects (string ids, ISO dates).
...
export function generateSeed(): Transaction[] {
